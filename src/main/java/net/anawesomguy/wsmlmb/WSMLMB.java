...
public final class WSMLMB implements ModInitializer {
     ...
     * <p>
     * This will later be iterated over in {@link WSMLMB#onInitialize()} so that everything in the {@link ConventionalItemTags#SHEARS c:shears} tag will be added to the condition's {@link MatchToolLootCondition#predicate predicate}'s {@link net.minecraft.predicate.item.ItemPredicate#items items} if it contains {@link Items#SHEARS}.
     *
     * @hidden
     */
